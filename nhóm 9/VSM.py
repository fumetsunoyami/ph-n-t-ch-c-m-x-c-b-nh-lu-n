...
# Chuẩn bị dữ liệu cho mô hình SVM
...
output_path = "output/ListCommentFacebook_labeled_svm.csv"
...
if os.path.exists(new_file_path):
    ...
    new_data['predicted_label'] = svm_model.predict(new_comments_tfidf)

    # Xuất file CSV với nhãn dự đoán
    new_data.to_csv('du_lieu_moi_du_doan_svm.csv', index=False)
